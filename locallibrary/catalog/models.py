...
# Constraints fields to unique values
...
class Genre(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        unique=True,
        help_text="Enter a book genre (e.g. Science Fiction, English Poetry etc.)"
    )
...
class Book(models.Model):
    ...
    isbn = models.CharField('ISBN', max_length=13,
                            unique=True,
                            help_text='13 Characters <a href="https://www.isbn-international.org/content/what-isbn'
                                      '">ISBN number</a>')
    
    """ManyToManyFlied used because genre can contain many books.
...
class Language(models.Model):
    """Model representing a Language (e.g. Russian, English, French etc.)"""
